...
namespace APK_VL
{
    public class ProfessorRepository
    {
        ...
        {
            conn.Open();
            SqlCommand cmd = new SqlCommand("Select * from Professor where username=@username and password=@password", conn);
        ...
        public int GetUserId(string username, string password)
        {
            ...
            int id;
            conn.Open();
            SqlCommand cmd = new SqlCommand("Select id from Professor where username=@username and password=@password", conn);
            cmd.Parameters.AddWithValue("@username", username);
            cmd.Parameters.AddWithValue("@password", password);
